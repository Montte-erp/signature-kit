...
<Cards>
  <Card title="Primeira assinatura" href="./get-started/quickstart" description="Carregue um A1, leia a identidade, assine bytes e verifique o resultado." />
  <Card title="Certificados A1" href="./signing/certificates" description="PKCS#12, identidade e-CPF / e-CNPJ, senha e falhas comuns de certificado." />
  <Card title="Fronteira de assinatura" href="./signing/signers" description="O contrato SignerAdapter e o serviço Signatures consumido por formatos e React." />
  <Card title="Fluxo PDF no navegador" href="./a1-signing/browser-pdf-flow" description="PDF entra, UI posiciona a assinatura, layer A1 roda só na ação do usuário." />
</Cards>
...
<Cards>
  <Card title="PDF/PAdES" href="./signing/pdf" description="CMS detached e tamanho de placeholder para documentos PDF." />
  <Card title="XML-DSig" href="./signing/xml" description="Mutação de XML com dependência explícita de XmlRuntime." />
  <Card title="APIs de provedores" href="./providers/request-shape" description="Clicksign, Assinafy, ZapSign, DocuSeal e Documenso como pacotes upstream explícitos." />
  <Card title="Catálogo de erros" href="./signing/errors" description="Códigos literais e metadados preservados em cada ponto de falha." />
</Cards>
