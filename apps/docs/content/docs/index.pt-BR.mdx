...
<Cards>
  <Card title="Primeira assinatura" href="/docs/get-started/quickstart" description="Carregue um A1, leia a identidade, assine bytes, valide um PDF e verifique o resultado." />
  ...
  <Card title="Fluxo PDF no navegador" href="/docs/signing/browser-pdf-flow" description="PDF entra, UI posiciona a assinatura, layer A1 roda só na ação do usuário." />
</Cards>
...
<Cards>
  ...
  <Card title="Validação ITI" href="/docs/signing/iti" description="Pré-checagem local AD-RB e cliente do Validar ITI oficial." />
  <Card title="Validade jurídica" href="/docs/concepts/legal-validity" description="Níveis de assinatura no Brasil, presunção ICP-Brasil, A1/A3 e limites da verificação." />
