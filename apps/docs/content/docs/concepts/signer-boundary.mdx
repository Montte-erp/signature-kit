...
<Cards>
  <Card title="The signing boundary" href="../signing/signers">Read the API-level SignerAdapter page.</Card>
  <Card title="PDF signing" href="../signing/pdf">See how the PDF format consumes Signatures.</Card>
</Cards>
