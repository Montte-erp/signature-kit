...
<Cards>
  <Card title="A fronteira de assinatura" href="../signing/signers">Leia a página de API do SignerAdapter.</Card>
  <Card title="Assinatura PDF" href="../signing/pdf">Veja como o formato PDF consome Signatures.</Card>
</Cards>
