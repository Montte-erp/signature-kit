...
<Cards>
  <Card title="PDF / PAdES" href="../signing/pdf">Visible rectangles, policies, and signed PDF bytes.</Card>
  <Card title="XML-DSig" href="../signing/xml">References, canonicalization, and XML mutation.</Card>
</Cards>
