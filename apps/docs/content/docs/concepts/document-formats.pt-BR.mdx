...
<Cards>
  <Card title="PDF / PAdES" href="../signing/pdf">Retângulos visíveis, políticas e bytes PDF assinados.</Card>
  <Card title="XML-DSig" href="../signing/xml">Referências, canonicalização e mutação XML.</Card>
</Cards>
