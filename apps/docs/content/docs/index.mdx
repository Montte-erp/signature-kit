...
<Cards>
  <Card title="Install A1" href="./get-started/installation" description="Add the Effect runtime, the core Signatures service, and the PKCS#12 signer." />
  <Card title="First signature" href="./get-started/quickstart" description="Load an A1 certificate, inspect the identity, sign bytes, and verify the result." />
  <Card title="PDF/PAdES" href="./signing/pdf" description="Sign PDFs by placing a detached CMS signature into a PDF placeholder." />
  <Card title="Browser PDF flow" href="./a1-signing/browser-pdf-flow" description="Read PDF bytes, render placement UI, and provide the A1 layer only at the action boundary." />
</Cards>
...
<Cards>
  <Card title="PDF/PAdES" href="./signing/pdf" description="Detached CMS signing and placeholder sizing for PDF documents." />
  <Card title="XML-DSig" href="./signing/xml" description="XML mutation through an explicit XmlRuntime dependency." />
  <Card title="Provider APIs" href="./providers/request-shape" description="Clicksign, Assinafy, ZapSign, DocuSeal, and Documenso as explicit upstream request packages." />
  <Card title="Error catalog" href="./signing/errors" description="Literal error codes and the metadata preserved at each failure point." />
</Cards>
