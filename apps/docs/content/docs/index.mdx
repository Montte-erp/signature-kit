...
<Cards>
  ...
  <Card title="First signature" href="/docs/get-started/quickstart" description="Load an A1 certificate, inspect the identity, sign bytes, validate a PDF, and verify the result." />
  ...
  <Card title="Browser PDF flow" href="/docs/signing/browser-pdf-flow" description="Read PDF bytes, render placement UI, and provide the A1 layer only at the action boundary." />
</Cards>
...
<Cards>
  ...
  <Card title="ITI validation" href="/docs/signing/iti" description="Local AD-RB conformance pre-checks plus the official Validar ITI client." />
  <Card title="Legal validity" href="/docs/concepts/legal-validity" description="Brazilian signature levels, ICP-Brasil presumption, A1/A3, and verification limits." />
