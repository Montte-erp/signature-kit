...
<Cards>
  <Card title="xml.INVALID_INPUT" href="./errors#error-catalog">Uma requisição de assinatura ou verificação inválida — incluindo fontes de confiança ausentes ou concorrentes.</Card>
  <Card title="xml.SIGN_FAILED" href="./errors#error-catalog">A operação de assinatura sobre o digest não pôde ser concluída, incluindo um referenceId não resolvível (nenhum elemento com esse Id).</Card>
</Cards>
...
<Cards>
  <Card title="xml.VERIFY_FAILED" href="./errors#error-catalog">A etapa de verificação em si não pôde ser concluída.</Card>
  <Card title="xml.SIGNATURE_NOT_FOUND" href="./errors#error-catalog">Nenhum elemento `<Signature>` foi encontrado no documento.</Card>
  <Card title="xml.KEY_IMPORT_FAILED" href="./errors#error-catalog">O `publicKeyDer`/`trustedCertificateDer` fornecido não pôde ser importado como chave de verificação.</Card>
</Cards>
