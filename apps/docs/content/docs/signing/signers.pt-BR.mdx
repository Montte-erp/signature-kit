...
<Cards>
  ...
  <Card title="signature-kit.UNSUPPORTED_ALGORITHM" href="/docs/signing/errors#error-catalog">O próprio container PKCS#12 carregado usa um algoritmo de criptografia não suportado, levantado ao fazer o parsing do certificado/chave — não ao escolher um `SignatureAlgorithm` fora do catálogo de assinatura, que falha como `signature-kit.INVALID_INPUT`.</Card>
