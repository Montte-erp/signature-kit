...
<Cards>
  <Card title="xml.INVALID_INPUT" href="./errors#error-catalog">An invalid signing or verification request — including missing or competing verification trust sources.</Card>
  <Card title="xml.SIGN_FAILED" href="./errors#error-catalog">The signing operation over the digest could not be completed, including an unresolvable referenceId (no element with that Id).</Card>
</Cards>
...
<Cards>
  <Card title="xml.VERIFY_FAILED" href="./errors#error-catalog">The verification step itself could not run to completion.</Card>
  <Card title="xml.SIGNATURE_NOT_FOUND" href="./errors#error-catalog">No `<Signature>` element was found in the document.</Card>
  <Card title="xml.KEY_IMPORT_FAILED" href="./errors#error-catalog">The provided `publicKeyDer`/`trustedCertificateDer` could not be imported as a verification key.</Card>
</Cards>
