...
<Cards>
  <Card title="xml.INVALID_INPUT" href="/docs/signing/errors#error-catalog">An invalid signing or verification request — including missing or competing verification trust sources.</Card>
