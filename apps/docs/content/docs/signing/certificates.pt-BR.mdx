...
- [`signature-kit.NO_CERTIFICATE`](./errors#error-catalog) — o material carregado não contém um certificado.
- [`signature-kit.X509_PARSE_FAILED`](./errors#error-catalog) — o DER não pôde ser parseado pelo `parseX509`.
- [`signature-kit.PEM_EXTRACTION_FAILED`](./errors#error-catalog) — falha ao extrair o PEM do certificado.

## Veja também

<Cards>
  <Card title="A camada de assinatura" href="./signers">O SignerAdapter que carrega o A1 e expõe o material de assinatura.</Card>
  <Card title="Canal de erros tipados" href="./errors">NO_CERTIFICATE, X509_PARSE_FAILED e os demais SignatureKitError.</Card>
</Cards>
